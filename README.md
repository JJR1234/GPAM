...
**Table2.R**: run this script to generate the results in Table 2.

**Table3.R**: run this script to generate the results in Table 3.

**TableS1.R**: run this script to generate the results in Table S1.
