...
for (iter in 1:100) {
    # Build the command
    cmd = paste("Rscript run_Model1.R", iter)
    cat("Running:", cmd, "\n")
    # Run the command
    system(cmd)
}

# summarize results into Table 1
...
print(res_xtable, file=paste(folder_path,"Table1.txt",sep=""),include.rownames=FALSE)
